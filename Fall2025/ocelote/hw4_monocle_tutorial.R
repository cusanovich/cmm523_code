...
integrated.sub <- subset(as.Seurat(cds,assay=NULL), monocle3_partitions == 1) #Tutorial doesn't have `assay=NULL`, but google search of error should point them in this direction
...
#This is the corrected line:
integrated.sub <- as.Seurat(cds, assay = NULL)#Tutorial has `assay = "integrated"` instead of `assay = NULL`, but google search of error should point them in this direction
